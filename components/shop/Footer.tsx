        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-12 md:gap-16 mb-16">
          ...
          <div>
            ...
            <p className="text-[13px] leading-[1.9] text-[var(--cream)]/45 max-w-[300px] font-light">
              Tu prenda es única y de edición limitada, diseñada y confeccionada desde cero con materiales reciclados, cuidadosamente seleccionados.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-[10px] tracking-[4px] uppercase text-[var(--accent)]/80 mt-3 mb-3">
              Contacto
            </p>
